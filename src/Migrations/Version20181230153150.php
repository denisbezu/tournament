 ...
 */
final class Version20181230153150 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `match` (id INT AUTO_INCREMENT NOT NULL, court_id INT DEFAULT NULL, tournament_id INT DEFAULT NULL, player1_id INT DEFAULT NULL, player2_id INT DEFAULT NULL, winner_id INT DEFAULT NULL, score VARCHAR(255) DEFAULT NULL, position INT DEFAULT NULL, INDEX IDX_7A5BC505E3184009 (court_id), INDEX IDX_7A5BC50533D1A3E7 (tournament_id), INDEX IDX_7A5BC505C0990423 (player1_id), INDEX IDX_7A5BC505D22CABCD (player2_id), INDEX IDX_7A5BC5055DFCD4B8 (winner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
